  ...
  return (
    <div className="bg-gradient-to-b from-brand-dark to-brand-blue items-center justify-items-center gap-16">
      <main className="flex flex-col row-start-2 items-center text-soft-white">
        <div className="flex md:flex-row-reverse md:m-0 mx-16 mt-8 flex-col md:gap-20 gap-8 items-center sm:px-20 py-8">
          <Image
          ...
          <div className="flex flex-col">
            <span className="text-3xl font-bold mb-4 font-oswald">
              Welcome to Gitchegumi Media
            </span>
            <span className="w-full md:text-lg font-oswald">

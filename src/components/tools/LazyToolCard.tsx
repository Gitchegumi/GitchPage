...
/**
 * LazyToolCard - Client-side rendered tool card for non-top-N tools
 *
 * This component is lazy-loaded via next/dynamic for tools that aren't
 * in the top-N pre-generated set. It shows a skeleton state until
 * hydrated, then renders the full tool card.
 */
...
export default function LazyToolCard({ tool }: LazyToolCardProps) {
  ...
  // Import dynamically to avoid SSR issues with Link
